...
const NavBar = () => {
  ...
  const { homepage, friends, jobs, messaging, notification, me, search } =
    messages[language];
  return (
        ...
        <div className="contant">
          ...
          <div className="signOutMobile px-2">
            ...
            <div className="signOut">
              <Link className="linkSign" onClick={handleLogout}>
                logOut
              </Link>
              <button className="bttn" onClick={() => dispatch(changeLang())}>
                {language}
              </button>
            </div>
          </div>
