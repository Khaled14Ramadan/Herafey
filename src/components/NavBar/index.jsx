...
const NavBar = () => {
    ...
    const { homepage, friends, jobs, messaging, notification, me, signOut, search } = messages[language];
    return (
                ...
                <div className="contant">
                    ...
                    <div className="signOutMobile px-2" >
                        ...
                        <div className="signOut">
                            <Link className="linkSign" to='home'>{signOut}</Link>
                            <button className="bttn" onClick={() => dispatch(changeLang())}>{language}</button>
                        </div>
                    </div>
                    <nav className="navBar">
                        <ul className="navContant">
